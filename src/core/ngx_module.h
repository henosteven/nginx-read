...
struct ngx_module_s {
    ...
    ngx_int_t           (*init_master)(ngx_log_t *log); //master 进程前要处理的事情

    ngx_int_t           (*init_module)(ngx_cycle_t *cycle); //模块初始化前处理的事情

    ngx_int_t           (*init_process)(ngx_cycle_t *cycle); //worker 进程前要处理的事情
    ngx_int_t           (*init_thread)(ngx_cycle_t *cycle); //暂时不用
    void                (*exit_thread)(ngx_cycle_t *cycle); //暂时不用
    void                (*exit_process)(ngx_cycle_t *cycle); //worker 结束要处理的事情

    void                (*exit_master)(ngx_cycle_t *cycle); //master 结束要处理的事情
